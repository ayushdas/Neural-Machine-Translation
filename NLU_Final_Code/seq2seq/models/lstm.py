...
class AttentionLayer(nn.Module):
   ...
   def score(self, tgt_input, encoder_out):
       ...
       projected_encoder_output and the corresponding targets of the batch inputs. The projected_encoder_output
       ...
       for the dot product with the target inputs.
           The resut of the matrix mutiplication enables the system, to obatin attention on the appropriate word.
       '''
