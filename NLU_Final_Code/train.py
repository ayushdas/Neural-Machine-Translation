...
def main(args):
    ...
    for epoch in range(last_epoch + 1, args.max_epoch):
        ...
        for i, sample in enumerate(progress_bar):
            ...
            '''
            '''
            The model is built and the CrossEntropyLoss is computed. 
            Then, the loss is propagated backwards within the network.
            The norm is computed over all the gradients and the weights are updated. 
            The ADAM optimization technique is then applied to update the network weights
            The gradients of all of the model parameters are set to zero.
            '''
